...
namespace MessageApp.MVVM.ViewModel
{
    internal class MainWindow_ViewModel : ObservableObject
    {
        ...
        private string GetAssemblyVersion()
        {
            ...
            string assablyNameVersionBuild = Assembly.GetExecutingAssembly().GetName().Version.Build.ToString();
            ...
            if (assablyNameVersionBuild != "0")
            {
                version += $".{assablyNameVersionBuild}";
            }
        ...
        public void GetResourceDictionary()
        {
            ...
            var beigeSkin = Themes.First();
            SelectedTheme = beigeSkin;
        }
    }
}